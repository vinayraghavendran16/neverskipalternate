...
- Shared role- and campus-aware calendar for exams, holidays, meetings and events
...
- Persistent notification inbox with platform-wide unread indicators
...
Payment-gateway settlement, offline queues and configured external notification providers remain required before a live multi-school pilot.
