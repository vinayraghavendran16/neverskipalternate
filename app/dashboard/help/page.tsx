...
export default async function HelpPage() {
  ...
  return <AppShell context={context} activePath="/dashboard/help" pageTitle="Help & releases">
    ...
    <section className="help-callout card" aria-labelledby="release-evidence-title"><div><span className="status">VERIFIED</span><h2 id="release-evidence-title">Release-readiness evidence</h2><p>The UAT report records the routes, roles, security checks, database regression, performance method, verified fixes and known limits for this release.</p></div><a className="primary compact" href="/reports/northstar-uat-release-readiness-2026-09-16.pdf" target="_blank" rel="noreferrer"><span>Open UAT report</span><span>↗</span></a></section>
