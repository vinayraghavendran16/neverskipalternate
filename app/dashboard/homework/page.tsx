...
export default async function HomeworkPage() {
  ...
  if ([staffResult, classResult, subjectResult, allocationsResult, homeworkResult, mappingsResult].some((result) => result.error)) throw new Error("School data could not be loaded. Please retry.");
