...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      platform_update_school_portfolio: { Args: { p_org:string; p_website_url:string; p_logo_url:string; p_school_type:string; p_education_board:string; p_established_year:number|null; p_affiliation_number:string; p_primary_email:string; p_primary_phone:string; p_onboarding_stage:string; p_go_live_on:string|null; p_customer_success_owner:string; p_plan_name:string; p_billing_cycle:string; p_recurring_amount:number; p_implementation_fee:number; p_contract_status:string; p_contract_starts_on:string|null; p_contract_ends_on:string|null; p_licensed_students:number|null; p_actor_user:string }; Returns:boolean };
